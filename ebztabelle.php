...
<body>
  ...
  <div class="table-responsive">
   ...
   while ($row = mysql_fetch_array($result)) {   //Creates a loop to loop through results
     ...
     "</td><td>" . $oldrow[7]. "</td><td>" . $oldrow[1] ."</td><td>"."</td><td>"."</td><td>"."</td><td>"."</td><td>"."</td><td>"."</td><td>". "</td></tr>";  //$row['index'] the index here is a field name
     $written = true;
     $oldrow = $newrow;
       }
   }
   if($written == false){
    ...
    "</td><td>" . "" . "</td><td>" . $newrow[1] ."</td><td>"."</td><td>"."</td><td>"."</td><td>"."</td><td>"."</td><td>"."</td><td>". "</td></tr>";  //$row['index'] the index here is a field name
   }
  ...
  $sql = "SELECT DISTINCT * FROM `Stundenplan` LEFT JOIN `EBZ` ON `Stundenplan`.`Klassen` =  `EBZ`.`ebzklasse` WHERE `Stundenplan`.`Klassen` = `EBZ`.`ebzklasse`";
   ...
   while ($row = mysql_fetch_array($result)) {   //Creates a loop to loop through results
     ...
     elseif($raum == $row[0] && $date == $row[2] && $teacher == $row[16]){
      ...
      "</td><td>" . $oldrow[7]. "</td><td>" . $oldrow[0] . "</td><td>"."</td><td>"."</td><td>"."</td><td>"."</td><td>"."</td><td>"."</td><td>"."</td></tr>";  //$row['index'] the index here is a field name  //$row['index'] the index here is a field name
     $written = true;
     $oldrow = $row;
     $oldrow = $newrow;
       }
   ...
   //if($written == false){
    ...
    //"</td><td>" . $newrow[7]. "</td><td>" . $newrow[0] . "</td><td>"."</td><td>"."</td><td>"."</td><td>"."</td><td>"."</td><td>"."</td><td>"."</td></tr>";  //$row['index'] the index here is a field name  //$row['index'] the index here is a field name
   //}
